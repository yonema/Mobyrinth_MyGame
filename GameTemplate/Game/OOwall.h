...
namespace nsMobyrinth
{
	...
	*/
	...
	{
		namespace nsReversibleObject { class ROrunning_stop; }
		/**
		 * @brief 障害オブジェクト
		*/
		namespace nsObstacleObject
		{
			...
			*/
			...
			public:		//メンバ関数
				...
				void SetRun_stop(nsReversibleObject::ROrunning_stop* run_stop)
				{
				...
				/// </summary>
				/// <returns></returns>
				nsReversibleObject::ROrunning_stop* GetRun_stop()
				{
					return m_pRun_stop;
				}
			...
			private:	//データメンバ
				...
				nsReversibleObject::ROrunning_stop* m_pRun_stop = nullptr;	//稼働、停止オブジェクトのポインタ
				bool m_firstUpdateFlag = true;			//一回目のアップデートか？
				nsSound::CSoundCue* m_wallmoveSE = nullptr;		//壁が動くときのサウンド
			};
