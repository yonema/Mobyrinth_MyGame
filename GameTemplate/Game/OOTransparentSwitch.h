		...
		namespace nsObstacleObject
		{
			...
			*/
			...
			private: //メンバ変数
				...
				nsGraphic::nsModel::CModelRender* m_pressedSwitchMR = nullptr;	//ボタンが押されたとき用のモデルレンダラー
				...
				*/
				...
				nsCamera::CGameCamera* m_gameCamera = nullptr;		//カメラのポインタ
				...
				*/
				...
				nsSound::CSoundCue* m_pressSwitchSC = nullptr;		//スイッチを押したときのサウンド
				nsSound::CSoundCue* m_entitySC = nullptr;			//透明アイテムが実体化した時のサウンド
				nsSound::CSoundCue* m_transparentSC = nullptr;		//実体化していた透明アイテムが透明になるときのサウンド
				nsSound::CSoundCue* m_timerSC = nullptr;				//タイマーのサウンド
				nsSound::CSoundCue* m_timerWarningSC = nullptr;		//警告タイマーのサウンド
			};
