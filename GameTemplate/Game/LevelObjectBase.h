	...
	namespace nsLevelObject
	{
		...
		*/
		...
		public:		//オーバーライドしてほしいメンバ関数
			...
			virtual nsGraphic::nsModel::CModelRender* GetModelRender(const int frontOrBack = 0)
			{
				return nullptr;
			}
		...
		private:	//データメンバ
			...
			*/
			...
			int m_frontOrBackSide = nsCommonData::EB_NONE_SIDE;	//自身が表側にあるか裏側にあるか
