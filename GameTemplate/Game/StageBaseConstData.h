...
namespace stageBaseConstData
{
	...
	*/
	...
	//火（透明）のオブジェクトタイプ
	constexpr int RO_TYPE_FIRE_TRANSPARENT = EN_RO_TYPE_FIRE + TYPE_TRANSPARENT_OBJECT;
	//釘（透明）のオブジェクトタイプ
	constexpr int RO_TYPE_NAIL_TRANSPARENT = EN_RO_TYPE_NAIL + TYPE_TRANSPARENT_OBJECT;
	//金槌（透明）のオブジェクトタイプ
	constexpr int RO_TYPE_HAMMER_TRANSPARENT = EN_RO_TYPE_HAMMER + TYPE_TRANSPARENT_OBJECT;
	//鍵（透明）のオブジェクトタイプ
	constexpr int RO_TYPE_KEY_TRANSPARENT = EN_RO_TYPE_KEY + TYPE_TRANSPARENT_OBJECT;
	//南京錠（透明）のオブジェクトタイプ
	constexpr int RO_TYPE_PADLOCK_TRANSPARENT = EN_RO_TYPE_PADLOCK + TYPE_TRANSPARENT_OBJECT;
	//ゴール（透明）のオブジェクトタイプ
	constexpr int OO_TYPE_GOAL_TRANSPARENT = EN_OO_TYPE_GOAL + TYPE_TRANSPARENT_OBJECT;
	//炎（透明）のオブジェクトタイプ
	constexpr int OO_TYPE_FLAME_TRANSPARENT = EN_OO_TYPE_FLAME + TYPE_TRANSPARENT_OBJECT;
	//箱（透明）のオブジェクトタイプ
	constexpr int OO_TYPE_BOX_TRANSPARENT = EN_OO_TYPE_BOX + TYPE_TRANSPARENT_OBJECT;
