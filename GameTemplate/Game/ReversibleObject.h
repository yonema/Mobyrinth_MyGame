		...
		namespace nsReversibleObject
		{
			...
			*/
			...
			protected:	//protectedなメンバ関数
				...
				{
					m_modelRender[nsCommonData::EN_FRONT]->SetModelEmissionColor(color);
					m_modelRender[nsCommonData::EN_BACK]->SetModelEmissionColor(color);
				}
			...
			private:	//データメンバ
				...
				* モデル関連
				*/
				nsGraphic::nsModel::CModelRender* m_modelRender[nsCommonData::EN_FRONT_AND_BACK_NUM] = { nullptr };	//表と裏のモデルレンダラー
				...
				*/
				...
				bool m_frontOrBack = nsCommonData::EN_FRONT;			//表か裏か？
				...
				*/
				//表と裏のオブジェクトのタイプ
				int m_reversibleType[nsCommonData::EN_FRONT_AND_BACK_NUM] = { EN_OBJECT_TYPE_EMPTY, EN_OBJECT_TYPE_EMPTY };
				...
				* スイッチ関連
				*/
				bool m_startFrontOrBack = nsCommonData::EN_FRONT;				//表か裏かの初期値
				...
				* サウンド関連
				*/
				nsSound::CSoundCue* m_changeSE = nullptr;		//性質反転するときのSE
				nsSound::CSoundCue* m_throwSE = nullptr;		//投げるときのSE
				nsSound::CSoundCue* m_capacityOverSE = nullptr;	//キャパシティがオーバーした時のSE
			};
