		...
		namespace nsShadow
		{
			...
			*/
			...
			public:		//メンバ関数
				...
				nsLight::ShadowParam* GetShadowParam()
				{
			...
			private:	//データメンバ
				...
				nsLight::ShadowParam m_shadowParam[nsLight::g_MAX_SHADOW_NUM];	//シャドウのパラメータ
				RenderTarget m_shadowMapRenderTarget;			//シャドウマップのレンダーターゲット
				nsPostEffect::CGaussianBlur m_gaussianBlur;					//ガウシアンブラー
