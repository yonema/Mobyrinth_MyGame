	...
	*/
	namespace nsUI
	{
		...
		private:	//データメンバ
			...
			nsLevel2D::CLevel2D m_level2D;
			nsGraphic::nsSprite::CSpriteRender* m_pause = nullptr;
			nsGraphic::nsSprite::CSpriteRender* m_choices[enPauseNum] = { nullptr };
			nsGraphic::nsSprite::CSpriteRender* m_cursor = nullptr;
			nsGraphic::nsSprite::CSpriteRender* m_background = nullptr;

			nsSound::CSoundCue* m_selectSE = nullptr;	//selectSEのサウンドキュー
			nsSound::CSoundCue* m_buttonASE = nullptr;	//buttonASEのサウンドキュー
			nsSound::CSoundCue* m_buttonBSE = nullptr;	//buttonBSEのサウンドキュー
		};
